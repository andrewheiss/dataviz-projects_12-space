...
format:
  ...
  typst:
    toc: true
    toc-title: Contents
    output-file: PREFIX_12-exercise.pdf
    pdf-standard: ua-1
...
#| fig-height: 6
#| fig-alt: |
#|   Choropleth map of the United States with Alaska and Hawaii repositioned
#|   for visibility. States are filled by US Census division using the turbo
#|   color scale, distinguishing nine divisions from New England in the
#|   northeast to the Pacific division in the west. White state borders and
#|   a top-positioned legend allow easy identification of each division.
...
#| fig-alt: |
#|   Choropleth map of the United States with Alaska and Hawaii repositioned,
#|   showing the proportion of households receiving SNAP benefits by state.
#|   The plasma color scale ranges from dark purple (lower proportions) to
#|   bright yellow (higher proportions), with a percent-formatted legend at
#|   the bottom. Southern and some Appalachian states tend toward higher
#|   SNAP usage rates.
...
#| out-width: "80%"
#| fig-alt: |
#|   County-level choropleth map of the Mountain division (Arizona, Colorado,
#|   Idaho, Montana, Nevada, New Mexico, Utah, Wyoming) showing the proportion
#|   of households receiving SNAP benefits. County borders appear in gray and
#|   state boundaries in thicker white lines. The plasma color scale ranges
#|   from dark purple (lower proportions) to bright yellow (higher
#|   proportions), revealing substantial geographic variation within the
#|   region.
...
#|   (Jordan), Cairo (Egypt), Durham (North Carolina), and Atlanta (Georgia).
#|   Red curved arrows trace great circle routes between locations in
#|   chronological order; each city is labeled with its name and the years
